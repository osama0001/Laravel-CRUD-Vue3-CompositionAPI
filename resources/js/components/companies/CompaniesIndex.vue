<template>
    ...
    >
        <div class="flex place-content-end mb-4">
            <div
                class="px-4 py-2 text-white bg-green-600 hover:bg-green-700 cursor-pointer"
            >
                <router-link
        ...
        <table class="min-w-full border divide-y divide-gray-200">
            <thead>
                <tr>
                    <th class="px-6 py-3 bg-gray-50" id="name">
                        <span
                            class="text-xs font-medium tracking-wider leading-4 text-left text-gray-500 uppercase"
                            >Name</span
                        >
                    </th>
                    <th class="px-6 py-3 bg-gray-50" id="email">
                        <span
                            class="text-xs font-medium tracking-wider leading-4 text-left text-gray-500 uppercase"
                            >Email</span
                        >
                    </th>
                    <th class="px-6 py-3 bg-gray-50" id="address">
                        <span
                            class="text-xs font-medium tracking-wider leading-4 text-left text-gray-500 uppercase"
                            >Address</span
                        >
                    </th>
                    <th class="px-6 py-3 bg-gray-50" id="website">
                        <span
                            class="text-xs font-medium tracking-wider leading-4 text-left text-gray-500 uppercase"
                            >Website</span
                        >
                    </th>
                    <th class="px-6 py-3 bg-gray-50" id="edit_delete"></th>
                </tr>
            </thead>
